                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="aksiDropdownRoom{{ $item->id }}">
                                        ...
                                        <li>
                                            <button type="button" class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#deleteModalRoom{{ $item->id }}">
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade modal-confirm" id="deleteModalRoom{{ $item->id }}" tabindex="-1" aria-labelledby="deleteModalLabelRoom{{ $item->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content text-center p-4">
                                            ...
                                            <div class="modal-body p-0">
                                                <h4 class="fw-bold mb-2" style="font-size:1.25rem;">Apakah Anda yakin ingin menghapus kamar ini?</h4>
                                                <div class="mb-4 text-muted" style="font-size:1rem;">"{{ ucfirst($item->type) }}"</div>
                                            </div>
                                            <div class="d-flex gap-2 justify-content-center mt-2">
                                                <button type="button" class="btn btn-outline-secondary btn-lg px-4" data-bs-dismiss="modal">Batal</button>
                                                <form action="{{ route('rooms.destroy', $item->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
