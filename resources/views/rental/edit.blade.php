        ...
        <div class="card-body">
            <form action="{{ route('rental.update', $rental->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_awal_sewa') is-invalid @enderror" id="tanggal_awal_sewa" name="tanggal_awal_sewa" value="{{ old('tanggal_awal_sewa', $rental->tanggal_awal_sewa ? $rental->tanggal_awal_sewa->format('Y-m-d') : '') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_akhir_sewa') is-invalid @enderror" id="tanggal_akhir_sewa" name="tanggal_akhir_sewa" value="{{ old('tanggal_akhir_sewa', $rental->tanggal_akhir_sewa ? $rental->tanggal_akhir_sewa->format('Y-m-d') : '') }}">
