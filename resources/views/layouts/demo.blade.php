...
>
  <head>
    ...
    <title>Aplikasi ABC Analysis</title>

    <meta name="description" content="Aplikasi ABC Analysis & Import Excel" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('home') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">ABC</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Management Barang -->
            <li class="menu-item {{ request()->routeIs('barang.*') || request()->routeIs('transaksi.*') ? 'open active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-box"></i>
                <div>Management Barang</div>
              </a>
              <ul class="menu-sub">
