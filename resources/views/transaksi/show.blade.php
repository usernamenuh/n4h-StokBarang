...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div><strong>Tanggal:</strong> {{ $transaksi->created_at }}</div>
            ...
            <div><strong>Diskon:</strong> Rp {{ number_format($transaksi->diskon, 2, ',', '.') }}</div>
            <div><strong>Ongkos Kirim:</strong> Rp {{ number_format($transaksi->ongkir, 2, ',', '.') }}</div>
