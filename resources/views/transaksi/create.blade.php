...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Tambah Transaksi Baru</h1>
        ...
        <form action="{{ route('transaksi.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="nomor" id="nomor" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nomor') border-red-500 @enderror" value="{{ old('nomor') }}" required>
                    @error('nomor')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" name="customer" id="customer" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('customer') border-red-500 @enderror" value="{{ old('customer') }}" required>
                    @error('customer')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" step="0.01" name="ongkos_kirim" id="ongkos_kirim" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('ongkos_kirim') border-red-500 @enderror" value="{{ old('ongkos_kirim', 0) }}" min="0">
                    @error('ongkos_kirim')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
